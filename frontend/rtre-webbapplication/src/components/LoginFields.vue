...
<div id="app">
    <v-app>
        <v-dialog v-model="dialog" persistent max-width="600px" min-width="360px">
            <div>
                <v-tabs v-model="tab" show-arrows background-color="blue" icons-and-text dark grow>
                                ...
                                <v-form ref="loginForm" v-model="valid" lazy-validation>
                                    <v-row>
                                        ...
                                        <v-col class="d-flex" cols="12" sm="3" xsm="12" align-end>
                                            <v-btn x-large block :disabled="!valid" :loading="loading[0]" color="success" @click="validateLogin">
                                                Login
                                            </v-btn>
                                        </v-col>
                                    </v-row>
        ...
        async validateRegister() {
            if (this.$refs.registerForm.validate()) {
                ...
                this.response = await fetch(
                    process.env.VUE_APP_RTRE_BACKEND_PORT + "/api/register?emailUsername=" +
                    this.email +
                    "&password=" +
                    this.password +
                    "&name=" +
